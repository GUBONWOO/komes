...
export const LAND_AREA_OPTIONS = [
  { label: 'すべて',    min: undefined, max: undefined },
  { label: '50㎡以上',  min: 50,        max: undefined },
  { label: '60㎡以上',  min: 60,        max: undefined },
  { label: '70㎡以上',  min: 70,        max: undefined },
  { label: '80㎡以上',  min: 80,        max: undefined },
  { label: '100㎡以上', min: 100,       max: undefined },
];
